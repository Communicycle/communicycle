...
const steps = [
  {
    ...
    description: "Pack your TVs, laptops, desktops, phones, tablets, and other electronics securely and ship them to us for a $30 dollar rebate per device or request scheduled/bulk pickup directly and we will come to you for free."
  },
  {
    icon: Search,
